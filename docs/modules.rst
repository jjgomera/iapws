...
Here are several problem iapws code have now and I can't know how to resolve:
...
I've tried to test all code and use all values for computer verification the standards give, but anyway the code can have problem hidden.
